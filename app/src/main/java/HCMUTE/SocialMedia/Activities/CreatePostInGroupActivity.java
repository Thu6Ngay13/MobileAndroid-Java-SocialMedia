...
public class CreatePostInGroupActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
...
long groupId = -1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            groupId = (bundle.getLong("GROUP_GROUPID"));}
    ...
    private void createPost() {
        ...
        btPost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PostCardModel post = new PostCardModel(avatar, username, fullName, "time", modeId, postText, postMedia,false, groupId);
                etTextPost.setText("");
                ivPostImage.setVisibility(View.GONE);

                Call<PostCardModel> call = apiService.createPostInGroup(post);
    ...
    private void loadData(){
        ...
        CreatePostAdapter createPostAdapter = new CreatePostAdapter(CreatePostInGroupActivity.this, modeImage, modeName);
